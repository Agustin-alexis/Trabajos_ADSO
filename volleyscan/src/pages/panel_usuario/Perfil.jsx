...
export default function Perfil() {
  ...
  const [objetivos, setObjetivos] = useState({
    ...
    sesiones:     4,
    duracion:     45,
    areas:        { remate: true, recepcion: true, saque: false, bloqueo: false, defensa: false },
  })
        ...
        <aside className="profile-sidebar">
          ...
          <div className="identity-card">
            <div className="avatar-wrap">
              <img src={photoSrc} alt="Foto de perfil" className="avatar-img" />
              ...
              <form onSubmit={handlePasswordSubmit} noValidate>
                ...
                <div className="danger-zone">
                  ...
                  <button className="btn btn--danger-outline" type="button"
                    onClick={() => setModal({ message: '¿Eliminar cuenta? Esta acción es permanente.', onConfirm: () => { sessionStorage.clear(); navigate('/') } })}>
